 ...
 * This file demonstrates how to integrate Daotorch with a web frontend
 */

// For React/Vue/Angular applications
export class DaotorchClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DaotorchClient(provider, contractAddress);
